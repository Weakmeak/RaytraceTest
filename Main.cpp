...
void initScene01(Scene& scene) {
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 0, 7, -1 }, 3.5f, std::make_unique<Lambertian>(color3{ 20, 20, 20 })));

	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ -2, 0, -1 }, 0.5f, std::make_unique<Dielectric>(color3{ 1, 1, 1 }, 0.3f)));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 0, 0, -1 }, 0.5f, std::make_unique<Lambertian>(color3{ 0.1f, 1, 0.1f })));
	scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 2, 0, -1 }, 0.5f, std::make_unique<Metal>(color3{ 1, 1, 1 })));
	scene.AddObject(std::make_unique<Plane>(glm::vec3{ 0.0, -0.5, 0.0 }, glm::vec3{ 0, 1, 0 }, std::make_unique<Lambertian>(color3{ 0.2f, 0.2f, 0.2f })));
}
